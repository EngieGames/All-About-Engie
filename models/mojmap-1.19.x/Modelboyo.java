...
public class Modelboyo<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(56, 9).addBox(
				-2.0F, 4.0F, -4.45F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 18.0F, 7.0F));
		...
		PartDefinition LowerLeg_r1 = leg1.addOrReplaceChild("LowerLeg_r1",
				CubeListBuilder.create().texOffs(36, 15).addBox(-1.995F, -4.5F, -1.0F, 4.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 6.25F, -2.95F, -0.5236F, 0.0F, 0.0F));

		PartDefinition MidLeg_r1 = leg1.addOrReplaceChild("MidLeg_r1",
				CubeListBuilder.create().texOffs(80, 22).addBox(-1.99F, 3.0F, -2.0F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition UpperLeg_r1 = leg1.addOrReplaceChild("UpperLeg_r1",
				CubeListBuilder.create().texOffs(56, 0).mirror()
						.addBox(-2.0F, 1.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, -3.2F, -1.225F, -0.2182F, 0.0F, 0.0F));

		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(56, 9).addBox(
				-2.0F, 4.0F, -4.45F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 18.0F, 7.0F));
		...
		PartDefinition UpperLeg_r2 = leg2.addOrReplaceChild("UpperLeg_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(-2.0F, 1.0F, -2.0F, 4.0F, 5.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.2F, -1.225F, -0.2182F, 0.0F, 0.0F));

		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(56, 9)
				.addBox(-2.0F, 4.0F, -4.25F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(56, 9).addBox(
				-2.0F, 4.0F, -4.25F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 18.0F, -5.0F));
