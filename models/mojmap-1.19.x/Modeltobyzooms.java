...
public class Modeltobyzooms<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tobyzooms"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bodyLayer_r1 = Body.addOrReplaceChild("bodyLayer_r1",
				CubeListBuilder.create().texOffs(60, 55)
						.addBox(-5.0F, -8.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.225F)).texOffs(0, 28)
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.1F, 3.8F, -1.2F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 2.25F, 4.25F, -0.3491F, 0.0F, 0.0F));
		...
		PartDefinition TailTertiary = TailSecondary.addOrReplaceChild("TailTertiary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 1.5F, 4.5F, 0.3491F, 0.0F, 0.0F));
