...
public class Modelmonstrosity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "monstrosity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(72, 16)
						...
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)).texOffs(3, 22)
						.addBox(-1.3F, -1.25F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.025F, -1.85F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.025F, 1.75F, 0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.025F, 4.15F, -1.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.025F, 7.95F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-3.025F, 7.15F, -1.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-3.025F, 5.55F, 0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-3.025F, 2.55F, -0.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-3.025F, -0.15F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-3.025F, -1.15F, 0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-0.7F, 1.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-2.1F, 3.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-0.7F, 6.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-1.7F, 6.75F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-2.7F, 3.35F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-0.2F, 0.25F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(64, 48)
						...
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)).texOffs(3, 22)
						.addBox(-0.3F, 1.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(1.1F, 3.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-0.3F, 6.75F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.7F, 6.75F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(1.7F, 3.35F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-0.8F, 0.25F, 1.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.3F, -1.25F, -2.025F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(0.5F, -2.025F, -0.525F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-1.025F, -1.85F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-1.025F, 1.75F, 0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-1.025F, 4.15F, -1.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(-1.025F, 7.95F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(2.025F, 7.15F, -1.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(2.025F, 5.55F, 0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(2.025F, 2.55F, -0.9F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
						.addBox(2.025F, -0.15F, -1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 22)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(48, 48)
						.addBox(0.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 48)
						.addBox(0.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)),
