...
public class Modelboyoaprilfoolszoomies<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "boyoaprilfoolszoomies"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 13.547F, -0.4808F, 1.5708F, 0.0F, 0.0F));

		PartDefinition backfinst_r1 = Body.addOrReplaceChild("backfinst_r1",
				CubeListBuilder.create().texOffs(9, 63)
						.addBox(-0.5F, -1.5F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(68, 0)
						.addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 60)
						.addBox(-0.5F, 0.5F, -3.5F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bodylayer_r1 = Body.addOrReplaceChild("bodylayer_r1",
				CubeListBuilder.create().texOffs(0, 24)
						.addBox(-5.0F, -8.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(0, 0)
						.addBox(-5.0F, -8.0F, -4.0F, 10.0F, 16.0F, 8.0F, new CubeDeformation(0.0F)),
