...
public class Modelbigboyosit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bigboyosit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 4.5F, 8.5F, 0.1396F, 0.0F, 0.0F));
		...
		PartDefinition TailTertiary = TailSecondary.addOrReplaceChild("TailTertiary", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 2.9F, 9.0F, 0.2094F, 0.0F, 0.0F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(72, 78)
						...
						.addBox(-8.0F, -12.8F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.05F)).texOffs(64, 160)
						.addBox(-8.0F, -12.8F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.15F)).texOffs(0, 160)
						.addBox(-8.0F, -12.8F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.2F)).texOffs(0, 104)
						.addBox(-8.0F, -12.8F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.5F)).texOffs(60, 126)
						.addBox(-8.0F, -12.8F, -16.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.6F)).texOffs(0, 0)
		...
		PartDefinition HeadFin_r1 = Head.addOrReplaceChild("HeadFin_r1",
				CubeListBuilder.create().texOffs(0, 136).addBox(-0.5F, -2.0F, 0.0F, 12.0F, 6.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition HeadFin_r2 = Head.addOrReplaceChild("HeadFin_r2",
				CubeListBuilder.create().texOffs(128, 128).addBox(-0.5F, -4.0F, 0.0F, 12.0F, 6.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(112, 18)
				.addBox(-3.9919F, 8.0081F, -8.9581F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0081F)).texOffs(60, 60)
		...
		PartDefinition Toe_r1 = leg1.addOrReplaceChild("Toe_r1", CubeListBuilder.create().texOffs(72, 58)
		...
		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(112, 18)
				.addBox(-3.9919F, 8.0081F, -6.7081F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0081F)).texOffs(60, 60)
				.addBox(-4.0668F, 10.0082F, -7.7082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
				.addBox(-2.0168F, 10.0082F, -7.7082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
				.addBox(0.0332F, 10.0082F, -7.7082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
		...
		PartDefinition Toe_r3 = leg3.addOrReplaceChild("Toe_r3", CubeListBuilder.create().texOffs(72, 58)
				.addBox(-1.0169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).texOffs(72, 58)
				.addBox(-3.0669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).texOffs(72, 58)
				.addBox(-5.1169F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)).texOffs(72, 58)
				.addBox(-7.1669F, -0.9919F, -1.0081F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0162F)),
		...
		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(112, 18)
				.addBox(-3.9919F, 8.0081F, -6.5081F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0081F)).texOffs(60, 60)
				.addBox(-4.0668F, 10.0082F, -7.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
				.addBox(-2.0168F, 10.0082F, -7.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
				.addBox(0.0332F, 10.0082F, -7.5082F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0164F)).texOffs(60, 60)
