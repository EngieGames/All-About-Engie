...
public class OrangeEnragedNormalEntity extends Monster {
	public OrangeEnragedNormalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ORANGE_ENRAGED_NORMAL.get(), world);
	}

	public OrangeEnragedNormalEntity(EntityType<OrangeEnragedNormalEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ORANGE_ENRAGED_NORMAL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
