...
public class OrangeEnragedSpeedEntity extends Monster {
	public OrangeEnragedSpeedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ORANGE_ENRAGED_SPEED.get(), world);
	}

	public OrangeEnragedSpeedEntity(EntityType<OrangeEnragedSpeedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ORANGE_ENRAGED_SPEED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
