...
public class EngieSharkoZoomiesEntity extends PathfinderMob {
	public EngieSharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_ZOOMIES.get(), world);
	}

	public EngieSharkoZoomiesEntity(EntityType<EngieSharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
