...
public class EpicSharkoZoomiesTiredEntity extends PathfinderMob {
	public EpicSharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public EpicSharkoZoomiesTiredEntity(EntityType<EpicSharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
