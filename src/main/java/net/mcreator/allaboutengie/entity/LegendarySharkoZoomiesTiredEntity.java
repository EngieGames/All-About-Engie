...
public class LegendarySharkoZoomiesTiredEntity extends PathfinderMob {
	public LegendarySharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public LegendarySharkoZoomiesTiredEntity(EntityType<LegendarySharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
