...
public class EnragedEngieEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(AllaboutengieModEntities.ENRAGED_ENGIE.get(), 10, 1, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ENRAGED_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
