...
public class SharkoZoomiesEntity extends PathfinderMob {
	public SharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_ZOOMIES.get(), world);
	}

	public SharkoZoomiesEntity(EntityType<SharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
