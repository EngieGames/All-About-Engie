...
public class ExoticSharkoZoomiesEntity extends PathfinderMob {
	public ExoticSharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EXOTIC_SHARKO_ZOOMIES.get(), world);
	}

	public ExoticSharkoZoomiesEntity(EntityType<ExoticSharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
