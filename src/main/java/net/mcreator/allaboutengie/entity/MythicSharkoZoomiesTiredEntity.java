...
public class MythicSharkoZoomiesTiredEntity extends PathfinderMob {
	public MythicSharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public MythicSharkoZoomiesTiredEntity(EntityType<MythicSharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
