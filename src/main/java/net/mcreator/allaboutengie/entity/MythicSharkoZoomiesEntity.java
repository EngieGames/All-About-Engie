...
public class MythicSharkoZoomiesEntity extends PathfinderMob {
	public MythicSharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.MYTHIC_SHARKO_ZOOMIES.get(), world);
	}

	public MythicSharkoZoomiesEntity(EntityType<MythicSharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
