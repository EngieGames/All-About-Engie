...
public class MadEngieEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(AllaboutengieModEntities.MAD_ENGIE.get(), 20, 1, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.MAD_ENGIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
