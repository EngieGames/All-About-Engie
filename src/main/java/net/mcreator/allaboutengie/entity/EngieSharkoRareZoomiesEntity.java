...
public class EngieSharkoRareZoomiesEntity extends PathfinderMob {
	public EngieSharkoRareZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_ZOOMIES.get(), world);
	}

	public EngieSharkoRareZoomiesEntity(EntityType<EngieSharkoRareZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
