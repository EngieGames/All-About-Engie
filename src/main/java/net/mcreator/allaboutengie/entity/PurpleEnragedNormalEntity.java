...
public class PurpleEnragedNormalEntity extends Monster {
	public PurpleEnragedNormalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PURPLE_ENRAGED_NORMAL.get(), world);
	}

	public PurpleEnragedNormalEntity(EntityType<PurpleEnragedNormalEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.PURPLE_ENRAGED_NORMAL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
