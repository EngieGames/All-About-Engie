...
public class AlbinoSharkoZoomiesTiredEntity extends PathfinderMob {
	public AlbinoSharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ALBINO_SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public AlbinoSharkoZoomiesTiredEntity(EntityType<AlbinoSharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
