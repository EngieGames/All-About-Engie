...
public class PurpleEnragedBoomEntity extends Monster {
	public PurpleEnragedBoomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PURPLE_ENRAGED_BOOM.get(), world);
	}

	public PurpleEnragedBoomEntity(EntityType<PurpleEnragedBoomEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.PURPLE_ENRAGED_BOOM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
