...
public class PurpleEnragedSpeedEntity extends Monster {
	public PurpleEnragedSpeedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.PURPLE_ENRAGED_SPEED.get(), world);
	}

	public PurpleEnragedSpeedEntity(EntityType<PurpleEnragedSpeedEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.PURPLE_ENRAGED_SPEED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
