...
public class SharkoZoomiesTiredEntity extends PathfinderMob {
	public SharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public SharkoZoomiesTiredEntity(EntityType<SharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
