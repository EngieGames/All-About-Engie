...
public class EpicSharkoZoomiesEntity extends PathfinderMob {
	public EpicSharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.EPIC_SHARKO_ZOOMIES.get(), world);
	}

	public EpicSharkoZoomiesEntity(EntityType<EpicSharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
