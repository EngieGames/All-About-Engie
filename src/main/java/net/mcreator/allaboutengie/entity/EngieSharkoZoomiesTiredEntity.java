...
public class EngieSharkoZoomiesTiredEntity extends PathfinderMob {
	public EngieSharkoZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_ZOOMIES_TIRED.get(), world);
	}

	public EngieSharkoZoomiesTiredEntity(EntityType<EngieSharkoZoomiesTiredEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
