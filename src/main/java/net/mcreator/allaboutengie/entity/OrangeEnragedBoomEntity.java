...
public class OrangeEnragedBoomEntity extends Monster {
	public OrangeEnragedBoomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ORANGE_ENRAGED_BOOM.get(), world);
	}

	public OrangeEnragedBoomEntity(EntityType<OrangeEnragedBoomEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AllaboutengieModEntities.ORANGE_ENRAGED_BOOM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
