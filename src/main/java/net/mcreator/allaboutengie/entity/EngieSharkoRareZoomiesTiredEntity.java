...
public class EngieSharkoRareZoomiesTiredEntity extends PathfinderMob {
	public EngieSharkoRareZoomiesTiredEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.ENGIE_SHARKO_RARE_ZOOMIES_TIRED.get(), world);
	}

	public EngieSharkoRareZoomiesTiredEntity(EntityType<EngieSharkoRareZoomiesTiredEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
