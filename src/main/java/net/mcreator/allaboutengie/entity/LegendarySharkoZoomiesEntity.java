...
public class LegendarySharkoZoomiesEntity extends PathfinderMob {
	public LegendarySharkoZoomiesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AllaboutengieModEntities.LEGENDARY_SHARKO_ZOOMIES.get(), world);
	}

	public LegendarySharkoZoomiesEntity(EntityType<LegendarySharkoZoomiesEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
