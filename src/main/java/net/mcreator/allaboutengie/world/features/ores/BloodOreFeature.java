...
public class BloodOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("allaboutengie:blood_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.NETHERRACK.defaultBlockState()), AllaboutengieModBlocks.BLOOD_ORE.get().defaultBlockState())), 8));
