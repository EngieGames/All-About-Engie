...
public class EnragedNormalRenderer extends HumanoidMobRenderer<EnragedNormalEntity, HumanoidModel<EnragedNormalEntity>> {
	...
	public ResourceLocation getTextureLocation(EnragedNormalEntity entity) {
		return new ResourceLocation("allaboutengie:textures/entities/red.png");
	}
}
