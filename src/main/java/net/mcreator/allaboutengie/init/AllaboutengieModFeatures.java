...
import net.mcreator.allaboutengie.world.features.ores.DeepslateUnobtainiumFeature;
...
public class AllaboutengieModFeatures {
	...
	public static final RegistryObject<Feature<?>> DEEPSLATE_UNOBTAINIUM = REGISTRY.register("deepslate_unobtainium", DeepslateUnobtainiumFeature::feature);
