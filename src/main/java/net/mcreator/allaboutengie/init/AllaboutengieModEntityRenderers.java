...
import net.mcreator.allaboutengie.client.renderer.EpicSharkoZoomiesTiredRenderer;
import net.mcreator.allaboutengie.client.renderer.EpicSharkoZoomiesRenderer;
...
public class AllaboutengieModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(AllaboutengieModEntities.EPIC_SHARKO_ZOOMIES.get(), EpicSharkoZoomiesRenderer::new);
		event.registerEntityRenderer(AllaboutengieModEntities.EPIC_SHARKO_ZOOMIES_TIRED.get(), EpicSharkoZoomiesTiredRenderer::new);
