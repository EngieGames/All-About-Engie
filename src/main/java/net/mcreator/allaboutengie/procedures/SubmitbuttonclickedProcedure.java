...
public class SubmitbuttonclickedProcedure {
	public static void execute(LevelAccessor world, Entity entity, HashMap guistate) {
		...
		if (AllaboutengieModVariables.WorldVariables.get(world).yeah == false) {
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("BANHAMMERUPDATECOOLIO")) {
				if ((entity.getCapability(AllaboutengieModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new AllaboutengieModVariables.PlayerVariables())).coderedeemblock == false) {
					{
						Entity _ent = entity;
						if (!_ent.level.isClientSide() && _ent.getServer() != null) {
					...
					if ((entity instanceof ServerPlayer _plr8 && _plr8.level instanceof ServerLevel
							&& _plr8.getAdvancements().getOrStartProgress(_plr8.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"))).isDone()) == false) {
						if (entity instanceof ServerPlayer _player) {
							Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"));
							AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
							if (!_ap.isDone()) {
			...
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("banhammerupdatecoolio")) {
				if ((entity.getCapability(AllaboutengieModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new AllaboutengieModVariables.PlayerVariables())).coderedeemblock == false) {
					...
					if ((entity instanceof ServerPlayer _plr13 && _plr13.level instanceof ServerLevel
							&& _plr13.getAdvancements().getOrStartProgress(_plr13.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"))).isDone()) == false) {
						if (entity instanceof ServerPlayer _player) {
							Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"));
							AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
							if (!_ap.isDone()) {
				...
				if ((entity.getCapability(AllaboutengieModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new AllaboutengieModVariables.PlayerVariables())).coderedeemblock == false) {
					...
					if ((entity instanceof ServerPlayer _plr18 && _plr18.level instanceof ServerLevel
							&& _plr18.getAdvancements().getOrStartProgress(_plr18.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"))).isDone()) == false) {
						if (entity instanceof ServerPlayer _player) {
							Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("allaboutengie:comically_massive_obtain"));
							AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
							if (!_ap.isDone()) {
		...
		if (AllaboutengieModVariables.seasonspring == true) {
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("spring")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("SPRING")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
		...
		} else if (AllaboutengieModVariables.seasonsummer == true) {
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("summer")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("SUMMER")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
		...
		} else if (AllaboutengieModVariables.seasonautumn == true) {
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("autumn")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("AUTUMN")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("fall")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("FALL")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
		...
		} else if (AllaboutengieModVariables.seasonwinter == true) {
			if (AllaboutengieModVariables.decembercodeblock == false) {
				if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("anallaboutengiechristmas")) {
					{
						Entity _ent = entity;
						if (!_ent.level.isClientSide() && _ent.getServer() != null) {
							_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
				...
				} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("ANALLABOUTENGIECHRISTMAS")) {
					{
						Entity _ent = entity;
						if (!_ent.level.isClientSide() && _ent.getServer() != null) {
							_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("winter")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
			...
			} else if ((guistate.containsKey("text:codeTextBox") ? ((EditBox) guistate.get("text:codeTextBox")).getValue() : "").equals("WINTER")) {
				{
					Entity _ent = entity;
					if (!_ent.level.isClientSide() && _ent.getServer() != null) {
						_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level instanceof ServerLevel ? (ServerLevel) _ent.level : null, 4,
