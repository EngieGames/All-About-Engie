...
public class UnpixelifyHammersProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (AllaboutengieModVariables.WorldVariables.get(world).yeah == false) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.BIGGER_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.BIGGEST_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.TRUE_BAN_HAMMER_NCMD_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(AllaboutengieModItems.KICK_BAN_HAMMER_PIXEL.get())) : false) {
				if (entity instanceof Player _player) {
