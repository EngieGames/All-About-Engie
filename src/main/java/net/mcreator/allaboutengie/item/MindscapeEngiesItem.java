...
public abstract class MindscapeEngiesItem extends ArmorItem {
	public MindscapeEngiesItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{600, 600, 600, 600}[slot.getIndex()];
			}
	...
	public static class Helmet extends MindscapeEngiesItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("He who watches."));
		}
